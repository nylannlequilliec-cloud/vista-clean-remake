...
import { useLayoutEffect, type MutableRefObject, ReactNode } from "react";
...
export function FormHarness({ initial, formRef, children }: FormHarnessProps) {
  ...
  // Pour se conformer aux règles strictes ESLint, on assigne la ref dans un effet de mise en page.
  useLayoutEffect(() => {
    if (formRef) {
