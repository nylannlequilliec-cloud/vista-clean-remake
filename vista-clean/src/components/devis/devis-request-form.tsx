    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          maxLength={100} // SECURITY: Limit input length to mitigate DoS/memory abuse
          value={devis.prenom}
          onChange={(event) => {
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          inputMode="tel"
          autoComplete="tel"
          maxLength={20} // SECURITY: Limit input length to mitigate DoS/memory abuse
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          id={besoinId}
          rows={5}
          maxLength={2000} // SECURITY: Limit input length to mitigate DoS/memory abuse
          value={devis.besoin}
          onChange={(event) => {
