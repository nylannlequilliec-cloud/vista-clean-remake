...
const BUBBLES: Bubble[] = [
  { l: "5%", w: 40, dur: 7, del: 0 }, { l: "15%", w: 18, dur: 9, del: 1.2 },
  { l: "22%", w: 55, dur: 11, del: 0.5 }, { l: "30%", w: 12, dur: 6, del: 3 },
  { l: "38%", w: 30, dur: 8, del: 2 }, { l: "45%", w: 65, dur: 13, del: 1 },
  { l: "52%", w: 20, dur: 7.5, del: 4 }, { l: "60%", w: 45, dur: 10, del: 0.8 },
  { l: "68%", w: 14, dur: 6.5, del: 5 }, { l: "75%", w: 35, dur: 9.5, del: 2.5 },
  { l: "82%", w: 50, dur: 12, del: 1.8 }, { l: "90%", w: 22, dur: 8, del: 3.5 },
  { l: "95%", w: 28, dur: 7, del: 6 }, { l: "10%", w: 60, dur: 14, del: 4.5 },
  { l: "50%", w: 16, dur: 5.5, del: 7 },
];

const DROPS: Drop[] = [
  { l: "10%", h: 80, dur: 3, del: 0 }, { l: "20%", h: 50, dur: 2.5, del: 1 },
  { l: "35%", h: 100, dur: 4, del: 0.5 }, { l: "50%", h: 60, dur: 2.8, del: 2 },
  { l: "65%", h: 90, dur: 3.5, del: 1.5 }, { l: "80%", h: 70, dur: 3, del: 3 },
  { l: "92%", h: 55, dur: 2.2, del: 0.8 }, { l: "42%", h: 85, dur: 3.8, del: 4 },
];

const SPARKLES: Sparkle[] = [
  { t: "15%", l: "20%", s: 8, dur: 2.5, del: 0 }, { t: "30%", l: "70%", s: 6, dur: 3, del: 1 },
  { t: "50%", l: "35%", s: 10, dur: 4, del: 0.5 }, { t: "70%", l: "55%", s: 7, dur: 3.5, del: 2 },
  { t: "40%", l: "85%", s: 9, dur: 2.8, del: 3 }, { t: "80%", l: "25%", s: 5, dur: 4.5, del: 1.5 },
  { t: "25%", l: "50%", s: 8, dur: 3, del: 4 }, { t: "60%", l: "10%", s: 6, dur: 3.2, del: 5 },
];
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      root.querySelectorAll<HTMLElement>("[data-bubble]").forEach((el, i) => {
        ...
        gsap.fromTo(el, { y: 0, scale: 1, opacity: 0.6 }, { y: () => -(vh() + 150), scale: 0.5, opacity: 0, duration: dur, delay: del, ease: "none", repeat: -1 });
      });

      root.querySelectorAll<HTMLElement>("[data-drop]").forEach((el, i) => {
        const { dur, del } = DROPS[i];
        gsap.fromTo(el, { y: -50, opacity: 0.8 }, { y: () => vh() + 50, opacity: 0, duration: dur, delay: del, ease: "none", repeat: -1 });
      });

      root.querySelectorAll<HTMLElement>("[data-sparkle]").forEach((el, i) => {
        const { dur, del } = SPARKLES[i];
        gsap.fromTo(el, { scale: 0, opacity: 0 }, { scale: 1, opacity: 0.8, duration: dur / 2, delay: del, ease: "sine.inOut", repeat: -1, yoyo: true });
      });
