...
export const tunnelStateSchema: z.ZodType<TunnelState> = z.strictObject({
  ...
  options: z.array(z.string().max(100, { message: "l'option est trop longue" })).max(50, { message: "trop d'options sélectionnées" }),
  lieu: z.strictObject({
  ...
  creneauId: z.string().max(100, { message: "l'identifiant de créneau est trop long" }).nullable(),
